---
description: >-
  Exploratory data analysis of the hunter dataset — country spread, bug/CWE
  frequency, numeric attributes, and report-count reconciliation — grounding
  later statistical testing in the actual data distribution.
icon: chart-mixed
---
...
* hunter\_stats.csv
* hunter\_hacktivity\_report\_counts.csv
* Stats.txt for the top bug-name and CWE frequency tables

The analysis covers 81 public hunters.

## Country Distribution

France dominates the public hunter set, accounting for 45 of 81 hunters, or about 55.6%. The next largest groups are Spain with 6 hunters, Sweden with 4, and China with 3. Most remaining countries contribute only one or two hunters each.

{% hint style="info" %}
**Interpretation.** The sample is geographically concentrated rather than globally balanced. That matters for later testing because any result may reflect a strong France-heavy composition rather than a uniform international population.
{% endhint %}
...
| Field   |      Mean |   Std Dev | Minimum                        | Maximum                     |   Skew |       IQR | Histogram bins                          |
| ------- | --------: | --------: | ------------------------------ | --------------------------- | -----: | --------: | --------------------------------------- |
| impact  |   20.0723 |    5.7483 | 5.1400 by Xiety, rank 21       | 37.1000 by zc, rank 51      | 0.1742 |    7.8000 | Freedman-Diaconis, 9 bins, width 3.551  |
| reports |  452.6173 |  639.4678 | 98.0000 by Mekky, rank 90      | 5610.0000 by rabhi, rank 1  | 6.8057 |  318.0000 | Freedman-Diaconis, 38 bins, width 145.1 |
| points  | 7159.0370 | 9557.7124 | 2586.0000 by Brumens, rank 100 | 84713.0000 by rabhi, rank 1 | 6.9547 | 3954.0000 | Freedman-Diaconis, 45 bins, width 1825  |
