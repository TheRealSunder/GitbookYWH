---
description: >-
  Verification flows, decisions, retention, and the most-asked Identity product
  questions.
icon: id-card
---
...
Most consumer products need only identity verification. ACH-accepting products add bank verification. Marketplaces and B2B platforms add KYB. The [decision tree](/broken/spaces/w7NRnYZuokE4h1mm2pJB/pages/CU3B57vTlXFuzpGarTTV#a-decision-tree) shows it visually.
...
The [re-verification tutorial](https://app.gitbook.com/s/Nankrp40VchJsUblU6h6/verify-customers-and-businesses/re-verification-trigger) covers the full implementation. For scheduled re-verification (every N months for regulated regimes), use the dashboard's scheduled re-verification feature instead of building it yourself.
...
Most teams use Plaid first with micro-deposits as fallback — covered automatically when you set `method: "auto"`. Walked through in the [Plaid bank verification tutorial](https://app.gitbook.com/s/Nankrp40VchJsUblU6h6/verify-customers-and-businesses/plaid-bank-verification).
...
* [Identity product space](https://app.gitbook.com/o/2DnmWBpytIOUKeXExonU/s/w7NRnYZuokE4h1mm2pJB/)
