---
description: >-
  Build your business on Evolve. Partner with us to deliver payments, identity,
  and platform solutions to your customers.
icon: handshake
...
<a href="https://gitbook.com" class="button primary">Apply to become a partner</a> <a href="https://gitbook.com" class="button secondary">Sign in to the partner portal</a>

### Why partner with Evolve

<table data-view="cards"><thead><tr><th></th><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><h4><i class="fa-percent" style="color:$primary;">:percent:</i></h4></td><td><strong>Revenue share</strong></td><td>Earn a share of every transaction your referrals process — for the lifetime of the relationship.</td><td></td></tr><tr><td><h4><i class="fa-headset" style="color:$primary;">:headset:</i></h4></td><td><strong>Dedicated support</strong></td><td>Direct line to a partner success manager. Slack channel for technical escalation.</td><td></td></tr><tr><td><h4><i class="fa-bullhorn" style="color:$primary;">:bullhorn:</i></h4></td><td><strong>Co-marketing</strong></td><td>Joint case studies, conference appearances, and curated lead lists for active partners.</td><td></td></tr></tbody></table>
...
You build a complementary product (CRM, analytics, fraud detection). Get listed in our [integrations directory](https://app.gitbook.com/o/2DnmWBpytIOUKeXExonU/s/MBT3EDUK7DzXmR0k9cje/) and access early-look APIs.
{% endcolumn %}
{% endcolumns %}
...
<a href="https://gitbook.com" class="button primary">Start your application</a> <a href="mailto:partners@evolve.com" class="button secondary">Email the partner team</a>
{% endif %}
...
<a href="deal-registration.md" class="button primary">Register a new deal</a> <a href="https://gitbook.com" class="button secondary">Open partner Slack</a>

### Quick links

<table data-view="cards"><thead><tr><th></th><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><h4><i class="fa-handshake-angle" style="color:$primary;">:handshake-angle:</i></h4></td><td><strong>Deal registration</strong></td><td>Register an opportunity, track deal status, see protection windows.</td><td><a href="deal-registration.md">deal-registration.md</a></td></tr><tr><td><h4><i class="fa-bullhorn" style="color:$primary;">:bullhorn:</i></h4></td><td><strong>Marketing resources</strong></td><td>Logos, brand kit, case studies, co-marketing templates.</td><td><a href="marketing-resources.md">marketing-resources.md</a></td></tr><tr><td><h4><i class="fa-graduation-cap" style="color:$primary;">:graduation-cap:</i></h4></td><td><strong>Training</strong></td><td>Certification programs, sales enablement, technical deep-dives.</td><td><a href="training.md">training.md</a></td></tr><tr><td><h4><i class="fa-headset" style="color:$primary;">:headset:</i></h4></td><td><strong>Partner support</strong></td><td>Direct line to your partner success manager. Escalation paths.</td><td><a href="support.md">support.md</a></td></tr></tbody></table>
...
<a href="support.md" class="button secondary">Contact details</a>
{% endcolumn %}
...
<a href="https://gitbook.com" class="button secondary">Open Slack</a>
{% endcolumn %}
{% endcolumns %}
{% endif %}
